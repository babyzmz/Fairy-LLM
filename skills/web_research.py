...
from cache.web_cache import get_cached, set_cache
from skills.crawl_webpage import CrawledPage, crawl_webpage
from skills.search_web import search_web_queries
from utils.web_content_extractor import ExtractedWebContent, extract_web_content
...
def extract_stage(crawled: CrawledPage | None) -> ExtractedWebContent | None:
    if crawled is None or not crawled.html.strip():
        return None
    try:
        return extract_web_content(crawled.html)
    except Exception:
        return None
