...
BUNDLE_NAME = "screen-understanding"
    ...
    *,
    ...
    if screen is None:
        return SkillResult(
            skill_name=BUNDLE_NAME,
            success=False,
            summary="Screen capability unavailable.",
            response_text="请求已接收，但当前屏幕理解能力暂不可用。",
            structured={"bundle_name": BUNDLE_NAME},
        )
    runner = ScreenUnderstandingSkill(screen=screen, llm_helper=services.llm_helper or services.llm)
