...
class AgentShellSkill:
    SPEC = SkillSpec(
        ...
        description="Inspect code, run terminal commands, browse the web, edit files, and validate changes.",
        trigger_hints=("代码", "仓库", "项目", "命令", "终端", "测试", "修复", "实现", "重构", "浏览网页", "对比网页"),
        allowed_tools=(
            "list_dir",
            "search_files",
            "read_text_file",
        ...
        execution_steps=("inspect", "tool_loop", "validate", "summarize"),
        output_schema=("summary", "changed_files", "commands_run", "validations", "sources"),
    )
