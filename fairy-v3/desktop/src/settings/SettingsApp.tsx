...
type KnowledgePrivacyData = Pick<
  SettingsData,
  "knowledgeSources" | "memoryProposals" | "obsidianHealth" | "knowledgeDiagnostics"
>;
...
function KnowledgePrivacyPanel(props: Parameters<typeof SettingsCategory>[0]) {
  const {
    data,
    busy,
    client,
...
async function loadKnowledgePrivacy(client: SettingsClient): Promise<KnowledgePrivacyData> {
