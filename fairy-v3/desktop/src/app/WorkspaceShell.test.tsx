...
function workspaceModel(): WorkspaceModel {
  return {
    ...
    backgroundTasksReady: true,
    chatTimelineTarget: null,
    chatSchedules: [],
    chatSchedulesLoading: false,
    projectTurn: null,
    projectTrace: null,
    ...
    openBackgroundTaskLocation: vi.fn(),
    clearChatTimelineTarget: vi.fn(),
    createChatSchedule: vi.fn(async () => undefined),
    updateChatSchedule: vi.fn(async () => undefined),
    pauseChatSchedule: vi.fn(async () => undefined),
    resumeChatSchedule: vi.fn(async () => undefined),
    runNowChatSchedule: vi.fn(async () => undefined),
    cancelChatSchedule: vi.fn(async () => undefined),
