...
from fairy_core.storage.research_schema import build_research_evidence_table
...
assistant_turns = Table(
    ...
    Column("active_interpretation_revision", BigInteger),
    Column("status", String(32), nullable=False),
    ...
    CheckConstraint(
        ...
        name="ck_core_assistant_turns_interpretation_revision",
    ),
    CheckConstraint(
...
assistant_tool_invocations = Table(
    ...
    Column("evidence_receipts", JSON, nullable=False),
    Column("error_code", String(128)),
    Column("created_at", UTCDateTime(), nullable=False),
    Column("updated_at", UTCDateTime(), nullable=False),
