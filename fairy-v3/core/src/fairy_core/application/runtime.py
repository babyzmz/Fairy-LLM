...
from fairy_core.application.runtime_pool import (
    ACTIVATABLE_TASK_STATUSES,
    RuntimePoolOperations,
)
...
class RuntimeApplication(RuntimePoolOperations, RuntimeApplicationSupport):
    @staticmethod
