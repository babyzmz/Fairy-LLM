...
> handling from commits `61191bc2` through `cab5d182`. They do not claim that
...
- [x] **Step 1: Write red domain tests for immutable binding, canonical hashing, validation, and Scope digest inclusion**
...
- [x] **Step 2: Run focused tests and confirm the missing-type failures**
...
- [x] **Step 3: Implement immutable retrieval value objects and canonical Snapshot hashing**
...
- [x] **Step 4: Add Task and Scope one-time bindings**
...
- [x] **Step 5: Add strict Pydantic contract models**
...
- [x] **Step 6: Run Core formatting, lint, and tests; commit Task 10**
...
- [x] **Step 1: Write red repository tests for atomic append/read, idempotent replay, tenant isolation, ordered items, and rollback**
...
- [x] **Step 2: Extend runtime metadata and SQLite storage**
...
- [x] **Step 3: Implement the connection-bound Snapshot repository**
...
- [x] **Step 4: Add Alembic revision `20260711_0005`**
...
- [x] **Step 5: Verify offline upgrade/downgrade DDL and real PostgreSQL when Docker exists**
...
- [x] **Step 6: Run Core/Cloud verification and commit Task 11**
...
- [x] **Step 1: Write dialect-neutral contract tests and malicious-query tests**
...
- [x] **Step 2: Bootstrap SQLite FTS5 as an external-content table**
...
- [x] **Step 3: Implement parameterized SQLite search**
...
- [x] **Step 4: Implement PostgreSQL generated-vector search**
...
- [x] **Step 5: Verify both adapters and commit Task 12**
...
- [x] **Step 1: Write red ranking, budget, conflict, expiry, fallback, and fixed-hash tests**
...
- [x] **Step 2: Implement deterministic candidate normalization and ranking**
...
- [x] **Step 3: Implement section budgets and hard-ceiling behavior**
...
- [x] **Step 4: Implement degraded relational fallback**
...
- [x] **Step 5: Add property tests for determinism and bounds**
...
- [x] **Step 1: Write red lifecycle and crash-point tests**
...
- [x] **Step 2: Implement canonical-to-projection refresh**
...
- [x] **Step 3: Run refresh only after canonical memory commits**
...
- [x] **Step 4: Bind a Snapshot during Task scope resolution**
...
- [x] **Step 5: Prove bounded-memory semantics**
...
- [x] **Step 6: Verify and commit Task 14**
...
- [x] **Step 1: Write REST/JSON-RPC/CoreClient parity tests before changing contracts**
...
- [x] **Step 2: Add transport-independent Core methods**
...
- [x] **Step 3: Add REST routes and generated TypeScript contracts**
...
- [x] **Step 4: Add runtime Zod validation and CoreClient groups**
...
- [x] **Step 5: Run contract verification and commit Task 15**
...
- [x] **Step 1: Add adversarial security and recovery tests**
...
- [x] **Step 2: Add real PostgreSQL/RLS integration tests**
...
- [x] **Step 3: Extend the full verification script**
...
- [x] **Step 4: Run the complete gate and commit Task 16**
...
- [x] **Step 1: Review the complete branch for boundary and naming drift**
...
- [x] **Step 2: Apply only milestone-local cleanup**
...
- [x] **Step 3: Update architecture and ADR**
...
- [x] **Step 4: Run the final gate from a clean worktree and commit Task 17**
