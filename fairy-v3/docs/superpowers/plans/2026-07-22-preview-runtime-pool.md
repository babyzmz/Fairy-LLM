...
> **Status: implemented.** All produced interfaces exist in `core` and `desktop`
> and their suites pass; checkboxes were reconciled retroactively on 2026-07-24
> after an implementation audit. Do not re-execute this plan.
...
- [x] **Step 2: Run focused tests and verify missing-field failures**
...
- [x] **Step 3: Add the domain field and monotonic store operations**
...
- [x] **Step 4: Add SQLite and PostgreSQL migrations**
...
- [x] **Step 5: Run persistence and migration tests**
...
- [x] **Step 2: Run tests and verify capacity behavior is absent**
...
- [x] **Step 3: Implement pure victim selection**
...
- [x] **Step 4: Implement stop-before-start activation**
...
- [x] **Step 5: Implement idle reaping**
...
- [x] **Step 1: Write failing contract and scheduler tests**
...
- [x] **Step 2: Run focused tests and verify missing RPC failures**
...
- [x] **Step 3: Add Pydantic activation contracts and handler**
...
- [x] **Step 4: Add scheduler lifecycle**
...
- [x] **Step 6: Run contracts and transport tests**
...
- [x] **Step 1: Write failing selection and stale-result tests**
...
- [x] **Step 2: Run Vitest and verify missing-hook failures**
...
- [x] **Step 3: Implement identity-deduplicated activation**
...
- [x] **Step 4: Refresh bound queries after activation**
...
- [x] **Step 5: Add compact Runtime status**
...
- [x] **Step 6: Run Desktop tests and type check**
...
- [x] **Step 1: Run complete Core and Capabilities suites**

Run: `uv run pytest core/tests capabilities/tests -q -p no:cacheprovider`

Expected: PASS.

- [x] **Step 2: Run complete Desktop suite and static checks**
...
- [x] **Step 3: Run migration and contract drift checks**
...
- [x] **Step 4: Restart only the development environment**
...
- [x] **Step 5: Perform real process-bound smoke**
