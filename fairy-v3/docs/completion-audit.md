...
| Presence, Pet, and Guide | Proven | Public-event projection tests, isolated Tauri capabilities, persistence/interaction tests, asset manifest, and `presence.spec.ts`. No LLM/Core execution API is exposed to Companion windows. |
